...
#let reset_glossary(use_show_ref: false) = [
  ...
  #glossary_entry(
    use_show: use_show_ref, "Compositor", [
      ...
      composition system.
      Often used to describe standalone wayland environments like Hyprland, Sway and river.
    ],
  )<compositor>
  #glossary_entry(
  ...
  #glossary_entry(
    use_show: use_show_ref, "Window Manager", [
      Provides window management without compositing them.
      With the X11 protocol, implementing an entire display server is not needed,
      therefore one can choose to simply provide, window spawning and window
      management.
      Examples include dwm, Xmonad, i3, herbstluftwm and more.
    ],
  )<window_manager>
  #glossary_entry(
