...
This section covers how users can install and configure the ReSet plugin system
along with their preferred plugins.
...
copying them into the right directory or directly passing a different
