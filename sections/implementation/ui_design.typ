...
ReSet will use Cambalache to build the UI. The reason for this it provides an
application in which the UI can be built with drag and drop. This makes it easy
to instantly see how the UI looks. Glade does provide the same functionality,
...
#align(
  center, [#figure(img("cambalache.png", width: 90%), caption: [Screenshot of Cambalache])<uimock1>],
)
