...
Each functinality defines their own DTO that will be sent to the user interface
application, which will then be able to utilize the data.

Plugins will handle their own data structure, the daemon will only send the data
