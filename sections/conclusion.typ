...
this thesis implemented both the plugin itself, and two exemplary plugins in
order to both prove and test the implementation.
...
The exemplary plugins prove that the plugin system works as expected and is able
...
the Rust programming language. On top of this, any change in compiler version
might break compatibility of a plugin. While this can also occur with major
