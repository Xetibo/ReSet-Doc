...
The other one is shortcuts. While there are some built-in shortcuts provided by GTK, we didn't add any of our own. This is because we didn't have enough time to implement them,
but we will add them in the future.
