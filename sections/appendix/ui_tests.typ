...
#test("Search bar", 
  "User can filter settings by typing in the search bar.")
#test("Dynamic window", 
...
#test("Closing window", 
  "User can close setting by clicking the X on the top right corner")
#test("Error handling", 
  "Errors are shown to the user")
#test("Theme", 
  "The theme of ReSet is changed correctly when changing the system theme and looks consistent")
#test("Readability", 
  "Font and font size should change based on system settings and should be readable for everyone")
#test("Navigation", 
  "All buttons are clearly labeled and lead to its intended location")
#test("Accessibility", 
