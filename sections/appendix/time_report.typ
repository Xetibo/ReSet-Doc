...
#align(
  center, [#figure(
      image("../../figures/timeReports/timeReport_01.png", width: 100%), 
      caption: [Time distribution of Sprint 1],
    )],
)
...
#align(
  center, [#figure(
      image("../../figures/timeReports/timeReport_04.png", width: 100%), 
      caption: [Time distribution of Sprint 4],
    )],
)
...
#align(
  center, [#figure(
      image("../../figures/timeReports/timeReport_13.png", width: 100%), 
