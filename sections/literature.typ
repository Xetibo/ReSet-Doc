...
- *"It doesn’t matter how many times I have to click, as long as each click is a
  ...
  There is a long-standing debate over menu layers in @kde-hamburger, the KDE side
  justifies these menus with increased functionality, while the GNOME side
...
- *"Reduce short-term memory load" - "The eight golden rules"* @shneiderman\
  ...
  new folder and anything else needs to be done with a terminal.
...
- *"Support internal locus of control" - "The eight golden rules"* @shneiderman\
  ...
  configured using a settings file that has to be created by the user.
