...
In @GNOMEoverride, the override function is visualized.
This function allows extension developers to override existing functionality within GNOME shell similarly to using hooks.
